...
export default function ChatDrawer({ onClose }) {
  ...
  return (
    <div className="w-320 h-[600px] bg-white dark:bg-gray-900 rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-700 overflow-hidden flex flex-col animate-slideUp">
      {/* Header */}
