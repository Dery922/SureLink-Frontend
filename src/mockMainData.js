// src/mockData/providers.js

// Single provider mock data (matching your backend format for the profile page)
  ...
  data: {
    ...
    services: [
      ...
      },
      {
        ...
        description:
          "CCTV and alarm system installation with remote monitoring",
        price: 180,
        duration: "4-6 hours",
        icon: "fa-video",
      },
    ...
    about:
      "With over 10 years of experience in the electrical industry, I specialize in residential and commercial electrical installations.",
    bio: "With over 10 years of experience in the electrical industry, I specialize in residential and commercial electrical installations.",
...
// Mock providers list (for the home page)
export const mockProvidersList = {
  ...
  data: [
    ...
    },
    {
      ...
      avatar: {
        url: "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=200&q=80",
      },
      provider_profile: {
