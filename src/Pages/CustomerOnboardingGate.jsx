...
export default function CustomerOnboarding() {
  ...
  const maskedPassword = form.password
              ...
              <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
                <div>
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400">
                    Set up your profile to get started with SureLink.
                  </p>
                </div>
                {showSaveBadge && (
              ...
              <div className="grid gap-5 md:grid-cols-[1.3fr_1fr]">
                <section className="rounded-2xl border border-brand-100 dark:border-gray-800 bg-white dark:bg-gray-900 p-6 sm:p-8 shadow-sm step-enter">
                  ...
                  <p className="mb-6 text-sm text-gray-500 dark:text-gray-400">
                    Your account has been created. You're all set to explore and
                    book services.
                  </p>
                  <div className="space-y-2.5 text-sm text-gray-600 dark:text-gray-400">
                    ...
                    <div className="flex items-start gap-2">
                      <Icon
                        ...
                        className="text-brand-500 mt-0.5 shrink-0"
                      />
                      You'll receive notifications when providers respond to
                      requests.
                    </div>
                  </div>
                ...
                >
                  ...
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      ...
                      <div className="inline-flex items-center rounded-full bg-emerald-100 dark:bg-emerald-900/40 px-2.5 py-0.5 text-xs font-semibold text-emerald-700 dark:text-emerald-400">
                        Active
                      </div>
                    </div>
                  </div>
              ...
              <div className="grid gap-5 md:grid-cols-[1.3fr_1fr]">
                        ...
                        <div className="mb-4 grid gap-4 sm:grid-cols-2">
                          <div>
                            ...
                            <input
                              ...
                              className={`${inputClass} ${fieldErrors.firstName ? "!border-red-400 dark:!border-red-500" : ""}`}
                            />
                          ...
                          <div>
                            ...
                            <input
                              ...
                              className={`${inputClass} ${fieldErrors.lastName ? "!border-red-400 dark:!border-red-500" : ""}`}
                            />
                        ...
                        <div className="mb-4">
                          ...
                          >
                            ...
                            <span className="tooltip-trigger relative">
                              ...
                              <span className="tooltip-content absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-48 rounded-lg bg-gray-800 dark:bg-gray-700 text-white text-xs p-2 shadow-lg z-10">
                                We'll use this for account notifications and
                                verification.
                              </span>
                            </span>
                          </label>
                          <div className="relative">
                            ...
                            <input
                              ...
                              className={`${inputIconClass} ${fieldErrors.email ? "!border-red-400 dark:!border-red-500" : ""}`}
                            />
                          </div>
                        ...
                        <div className="mb-4">
                          ...
                          >
                            ...
                            <span className="tooltip-trigger relative">
                              ...
                              />
                              <span className="tooltip-content absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-48 rounded-lg bg-gray-800 dark:bg-gray-700 text-white text-xs p-2 shadow-lg z-10">
                                Include your country code. We may use this for
                                SMS verification.
                              </span>
                            </span>
                          </label>
                          <div className="relative">
                            ...
                            <input
                              ...
                              className={`${inputIconClass} ${fieldErrors.phone ? "!border-red-400 dark:!border-red-500" : ""}`}
                            />
                          </div>
                        ...
                        <div className="mb-4">
                          ...
                          >
                            ...
                            <span className="tooltip-trigger relative">
                              ...
                              />
                              <span className="tooltip-content absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-48 rounded-lg bg-gray-800 dark:bg-gray-700 text-white text-xs p-2 shadow-lg z-10">
                                Select the region where you primarily need
                                services.
                              </span>
                            </span>
                          </label>
                    ...
                    >
                      <div className="rounded-xl border border-purple-200 dark:border-purple-900/50 bg-purple-50/50 dark:bg-purple-900/10 p-5">
                        ...
                        <div className="flex items-center gap-5">
                          ...
                          <div className="flex-1">
                            ...
                            <p className="text-xs text-gray-500 dark:text-gray-400 mb-3">
                              Helps providers recognize you when they arrive.
                            </p>
                            <div className="flex items-center gap-2">
                              <button
                                type="button"
                        ...
                        <div className="mt-5 rounded-xl bg-brand-50 dark:bg-brand-900/20 border border-brand-100 dark:border-brand-800 p-3 text-xs text-brand-700 dark:text-brand-400 flex items-start gap-2">
                          ...
                          />
                          <span>
                            Your profile photo is only visible to providers you
                            contact. We never share it publicly.
                          </span>
                        </div>
                      </div>
                    </section>
                  ...
                  {currentStep === "review" && (
                    ...
                    >
                      <div className="space-y-4 rounded-xl border border-emerald-200 dark:border-emerald-900/50 bg-emerald-50/40 dark:bg-emerald-900/10 p-5">
                        ...
                        <p className="text-sm text-gray-500 dark:text-gray-400">
                          Final confirmation before creating your account.
                        </p>
                ...
                <aside className="h-fit rounded-2xl border border-brand-100 dark:border-gray-800 bg-white dark:bg-gray-900 p-6 shadow-sm md:sticky md:top-24">
                  ...
                  <div className="rounded-xl bg-brand-50 dark:bg-brand-900/20 p-3.5 text-xs text-brand-700 dark:text-brand-400 flex items-start gap-2">
                    ...
                    />
                    <span>
                      Tip: Complete your profile with a photo and accurate
                      location to get better service matches.
                    </span>
                  </div>
                </aside>
              </div>
