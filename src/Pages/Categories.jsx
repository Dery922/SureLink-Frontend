...
function CategoryResults() {
  ...
  const currentSortLabel =
    sortOptions.find((opt) => opt.value === activeFilter)?.label ||
    "Recommended";
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
              <div>
                ...
                <p className="text-sm text-gray-500 mt-1">
                  ...
                  {sortedProviders.length === 1 ? "provider" : "providers"}{" "}
                  found
                </p>
              </div>
              ...
              <div className="relative" ref={dropdownRef}>
                ...
                >
                  ...
                  <i
                    className={`fa-solid fa-chevron-down text-xs text-gray-400 transition-transform ${isDropdownOpen ? "rotate-180" : ""}`}
                  ></i>
                </button>
                      ...
                      <button
                        ...
                        className={`w-full px-4 py-2.5 text-left text-sm hover:bg-[#F5F8FF] transition-colors flex items-center gap-2 ${
                          selectedCategory === category
                            ? "bg-[#F5F8FF] text-[#0057FF] font-medium"
                            : "text-gray-700"
                        }`}
                      >
                        {selectedCategory === category && (
                        ...
                        <span
                          className={
                            selectedCategory === category ? "ml-0" : "ml-5"
                          }
                        >
            ...
            <div className="flex items-center gap-3 overflow-x-auto scrollbar-hide flex-1">
              ...
              <div className="relative" ref={sortDropdownRef}>
                ...
                >
                  ...
                  <i
                    className={`fa-solid fa-chevron-down text-xs text-gray-400 transition-transform ${isSortDropdownOpen ? "rotate-180" : ""}`}
                  ></i>
                </button>
                  ...
                  <div className="absolute top-full left-0 mt-2 min-w-[200px] bg-white border border-[#E8F0FF] rounded-xl shadow-lg py-2 z-50 animate-fadeIn">
                    {sortOptions.map((option) => (
                      ...
                      >
                        ...
                        <span
                          className={
                            activeFilter === option.value ? "ml-0" : "ml-5"
                          }
                        >
                          {option.label}
                        </span>
