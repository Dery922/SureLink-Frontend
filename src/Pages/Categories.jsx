...
const filters = ['All', 'Top Rated', 'Price: Low to High', 'Price: High to Low', 'Most Reviews']
            ...
            <div className="pt-[72px]">
                ...
                <div className="bg-[#F5F8FF] py-10">
                    <div className="max-w-[1280px] mx-auto px-5">
                        <h1 className="text-3xl font-bold text-[#1A1A1A] mb-1">{categoryName} Services</h1>
                        <p className="text-sm text-gray-500">{displayProviders.length} providers found</p>
                    </div>
                </div>

                {/* Filter bar */}
                <div className="border-b border-gray-100 bg-white sticky top-[72px] z-40">
                    <div className="max-w-[1280px] mx-auto px-5 py-3 flex items-center gap-3 overflow-x-auto">
                        {filters.map((filter, index) => (
                            <button
                                key={index}
                                className={`whitespace-nowrap px-4 py-2 rounded-full text-sm font-medium border transition-all ${index === 0
                        ...
                        {displayProviders.map((provider) => (
                            ...
                            >
                                ...
                                <div className="p-4 pt-6 relative">
                                    ...
                                    {/* Price */}
                                    <p className="text-sm font-bold text-[#0057FF] mb-2">{provider.price}</p>
