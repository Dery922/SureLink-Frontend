            ...
            <section className="bg-[#F5F8FF] pt-[72px]">
                <div className="max-w-[1280px] mx-auto px-5 py-12 md:py-20 flex flex-col md:flex-row items-center justify-between gap-10">
                    ...
                    <div className="flex-1 w-full max-w-full md:max-w-[560px]">
                        <img
                            src="https://images.unsplash.com/photo-1621905251918-48416bd8575a?q=80&w=1469&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                    ...
                    <div className="grid grid-cols-4 md:grid-cols-8 gap-3 md:gap-4">
                        {categories.map((cat, index) => (
                            <Link
                                to={`/category/${cat.id}`}
                                key={index}
                                className="flex flex-col items-center justify-center bg-white border border-[#E8F0FF] rounded-2xl p-2 md:p-4 h-[100px] md:h-[120px] hover:border-[#0057FF] hover:bg-[#F5F8FF] transition-all cursor-pointer"
                            >
                                <div className="w-10 h-10 md:w-12 md:h-12 bg-[#E8F0FF] rounded-xl flex items-center justify-center mb-2 md:mb-3">
            ...
            <section className="bg-[#F5F8FF] py-12 md:py-16">
                <div className="max-w-[1280px] mx-auto px-5">
                    <div className="flex items-center justify-between mb-8">
                        ...
                        <a href="/category/all" className="text-sm text-[#0057FF] hover:underline">See all</a>
                    </div>
