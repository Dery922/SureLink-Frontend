...
const INITIAL_FORM = {
  firstName: "", // 🎯 Fixed: Matches your new name input fields
  lastName: "", // 🎯 Fixed: Matches your new name input fields
  category: "",
  secondaryCategory: "",
  area: "",
  radius: "5",
  ...
  const icons = {
    ...
    save: (
      <svg
        ...
        className={className}
      >
        <path d="M15.2 3a.6.6 0 0 1 .4.2l3.2 3.2a.6.6 0 0 1 .2.4V21a.6.6 0 0 1-.6.6H3.6a.6.6 0 0 1-.6-.6V3.6a.6.6 0 0 1 .6-.6z" />
...
export default function ProviderOnboarding() {
  ...
  const validateReview = useCallback(() => {
    ...
    // 🛡️ Guard checks for document data captured in step 2
    ...
    // 🛡️ Guard check for the final confirmation checkbox
    if (!form.consent)
  ...
  const goNext = useCallback(async () => {
    ...
    try {
      ...
      // 2. 🔑 SAVE TO BACKEND DRAWS ON EVERY CONTINUOUS STEP ACTION
      // This synchronizes their typed inputs directly with MongoDB using stateless JWT headers
      await api.post(
        "/auth/provider-profile/draft",
        {
          profileDetails: form,
          currentStep: currentStep, // Sends 'profile' or 'verification'
        },
        {
          headers: {
      ...
      // 3. Save a fallback copy to LocalStorage instantly
      localStorage.setItem(STORAGE_KEY, JSON.stringify(form));

      // 4. Advance the UI wizard step safely
  ...
  const handleSubmit = useCallback(async () => {
    ...
    setFormError("");
    try {
      // 🔑 Retrieve your security authorization token
      const token =
      ...
      // 🚀 Post dataset directly to your final submission profile route
      const { data } = await api.post(
        "/auth/provider-profile", // 💡 Ensure this string matches your final backend router mount path exactly
        {
          profileDetails: form,
        },
        {
          // 🎯 FIX: Single headers wrapper level maps token cleanly to backend middleware
          headers: {
  ...
  const handleSaveDraft = useCallback(async () => {
    try {
      ...
      // 🔑 Retrieve your authentication token (adjust key name to match your app)
      const token =
      ...
      // Call your backend draft endpoint with Auth Headers
      const { data } = await api.post(
        "/auth/provider-profile/draft",
        ...
        {
          headers: {
            // 🛡️ Pass the token to satisfy your backend protectAuth middleware
            Authorization: `Bearer ${token}`,
          },
        },
      );
  ...
  const inputClass =
    "w-full rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 px-4 py-3 text-sm input-glow transition focus:border-brand-500 focus:outline-none focus:ring-2 focus:ring-brand-100 dark:focus:ring-brand-900 disabled:opacity-50";
  const inputIconClass =
    "w-full rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 pl-9 pr-4 py-3 text-sm input-glow transition focus:border-brand-500 focus:outline-none focus:ring-2 focus:ring-brand-100 dark:focus:ring-brand-900 disabled:opacity-50";
  const priceClass =
    "w-full rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 pl-8 pr-4 py-3 text-sm input-glow transition focus:border-brand-500 focus:outline-none focus:ring-2 focus:ring-brand-100 dark:focus:ring-brand-900 disabled:opacity-50";
  ...
  const ringColor =
    progress >= 80 ? "#10B981" : progress >= 50 ? "#F59E0B" : "#3A9AFF";
  ...
  return (
    <div className="font-sans bg-gray-50 dark:bg-gray-950 text-gray-900 dark:text-gray-100 min-h-screen flex flex-col antialiased">
      ...
      <nav
        id="navbar"
        className="fixed top-0 inset-x-0 z-50 bg-white/90 dark:bg-gray-900/90 backdrop-blur-md border-b border-gray-100 dark:border-gray-800 transition-shadow"
      >
        <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <button
              onClick={toggleDark}
              className="w-9 h-9 rounded-xl border border-gray-200 dark:border-gray-700 flex items-center justify-center hover:bg-gray-100 dark:hover:bg-gray-800 transition"
            ...
            <a
              href="#"
              className="hidden sm:inline-flex items-center gap-1.5 text-sm font-medium text-gray-600 dark:text-gray-400 hover:text-brand-500 transition"
            >
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-6 sm:py-10">
          ...
          <div className="mb-6 rounded-2xl border border-brand-100 dark:border-gray-800 bg-white dark:bg-gray-900 p-5 sm:p-7 shadow-sm">
            <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
              <div>
                ...
                <h1 className="mb-1.5 text-2xl sm:text-3xl font-extrabold tracking-tight">
          ...
          {submitted ? (
            <div className="grid gap-5 md:grid-cols-[1.3fr_1fr]">
              <section className="rounded-2xl border border-brand-100 dark:border-gray-800 bg-white dark:bg-gray-900 p-6 sm:p-8 shadow-sm step-enter">
                ...
                <div className="mt-8 flex flex-wrap gap-3">
                  <button
                    ...
                    className="inline-flex items-center gap-2 rounded-xl bg-brand-500 px-5 py-3 text-sm font-bold text-white hover:bg-brand-600 active:scale-[0.97] transition"
                  >
                  ...
                  <Link
                    to="/"
                    className="inline-flex items-center gap-2 rounded-xl border border-gray-200 dark:border-gray-700 px-5 py-3 text-sm font-semibold hover:bg-gray-50 dark:hover:bg-gray-800 transition"
                  >
              ...
              <aside
                className="rounded-2xl border border-brand-100 dark:border-gray-800 bg-brand-50/50 dark:bg-gray-900 p-6 shadow-sm step-enter"
              ...
              >
                ...
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <div className="inline-flex items-center rounded-full bg-amber-100 dark:bg-amber-900/40 px-2.5 py-0.5 text-xs font-semibold text-amber-700 dark:text-amber-400">
                      Pending review
                    </div>
                  </div>
                </div>
            ...
            <div className="grid gap-5 md:grid-cols-[1.3fr_1fr]">
              <form
                ...
                className="space-y-5 rounded-2xl border border-brand-100 dark:border-gray-800 bg-white dark:bg-gray-900 p-5 sm:p-7 shadow-sm"
              >
                {/* ===== STEP: PROFILE ===== */}
                {currentStep === "profile" && (
                  <section
                        ...
                        <div>
                          ...
                          <div className="relative">
                            ...
                            <input
                              ...
                              className={`${inputIconClass} ${fieldErrors.firstName ? "!border-red-400 dark:!border-red-500" : ""}`}
                            />
                          </div>
                        ...
                        <div>
                          ...
                          <div className="relative">
                            ...
                            <input
                              ...
                              className={`${inputIconClass} ${fieldErrors.lastName ? "!border-red-400 dark:!border-red-500" : ""}`}
                            />
                          </div>
                      ...
                      <div className="mb-4">
                        ...
                        >
                          ...
                          <span className="tooltip-trigger relative">
                            ...
                            />
                            <span className="tooltip-content absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-48 rounded-lg bg-gray-800 dark:bg-gray-700 text-white text-xs p-2 shadow-lg z-10">
                              Choose the category that best represents your main
                              service.
                            </span>
                          </span>
                        </label>
                        ...
                        >
                          ...
                          <span className="tooltip-trigger relative">
                            ...
                            <span className="tooltip-content absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-52 rounded-lg bg-gray-800 dark:bg-gray-700 text-white text-xs p-2 shadow-lg z-10">
                              Describe your experience, strengths, and what
                              customers can expect. This appears on your public
                              profile.
                            </span>
                          </span>
                        </label>
                      ...
                      <div className="mb-4 grid gap-4 sm:grid-cols-2">
                        <div>
                          ...
                          <select
                            ...
                            className={`${inputClass} ${fieldErrors.idType ? "!border-red-400 dark:!border-red-500" : ""}`}
                          >
                        ...
                        <div>
                          ...
                          <input
                            ...
                            className={`${inputClass} ${fieldErrors.idNumber ? "!border-red-400 dark:!border-red-500" : ""}`}
                          />
                        ...
                        >
                          {!form.docName ? (
                            <div className="p-6 text-center flex flex-col items-center gap-2">
                              <div
                                className={`drop-icon w-12 h-12 rounded-full bg-brand-50 dark:bg-brand-900/30 flex items-center justify-center ${dragOver ? "scale-110" : ""}`}
                              >
                                <Icon
                                  name="upload-cloud"
                                  size={24}
                    ...
                    <div className="space-y-4 rounded-xl border border-emerald-200 dark:border-emerald-900/50 bg-emerald-50/40 dark:bg-emerald-900/10 p-5">
                      ...
                      <label className="flex items-start gap-3 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-4 cursor-pointer select-none hover:border-brand-300 transition">
                        <div className="relative mt-0.5">
                          ...
                          />
                          <div
                            className={`w-5 h-5 rounded border-2 flex items-center justify-center transition-colors ${form.consent ? "bg-brand-500 border-brand-500" : "border-gray-300 dark:border-gray-600"}`}
                          >
                            {form.consent && (
                              <Icon
                                name="check"
                ...
                <div className="sticky bottom-4 z-10 flex flex-wrap gap-2.5 rounded-xl border border-gray-100 dark:border-gray-800 bg-white/95 dark:bg-gray-900/95 p-3 shadow-lg backdrop-blur-md">
                  {currentStep !== "profile" && (
                    <button
                      type="button"
                      onClick={goBack}
                      className="inline-flex items-center gap-1.5 rounded-xl border border-gray-200 dark:border-gray-700 px-4 py-2.5 text-sm font-semibold hover:bg-gray-50 dark:hover:bg-gray-800 active:scale-[0.97] transition"
                    >
                  ...
                  {currentStep !== "review" ? (
                    <button
                      ...
                      onClick={goNext}
                      disabled={loading}
                      className="inline-flex items-center gap-1.5 rounded-xl bg-brand-500 px-5 py-2.5 text-sm font-bold text-white hover:bg-brand-600 active:scale-[0.97] disabled:opacity-50 disabled:cursor-not-allowed transition"
                    >
                      Continue
                  ...
                  <a
                    href="#"
                    className="inline-flex items-center gap-1.5 rounded-xl border border-gray-200 dark:border-gray-700 px-4 py-2.5 text-sm font-semibold hover:bg-gray-50 dark:hover:bg-gray-800 transition"
                  >
                    <Icon name="home" size={16} />
                    Home
                  </a>
                ...
                <div className="space-y-2.5 mb-5">
                  {[
                    ...
                    >
                      ...
                      <span
                        className={`transition-colors ${checklist[key] ? "text-gray-900 dark:text-gray-100 line-through" : "text-gray-600 dark:text-gray-400"}`}
                      >
                        {label}
                      </span>
                    </div>
